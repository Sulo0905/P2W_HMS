                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="font-semibold text-primary text-xl"> Turner</p>
                            </div>
                                ...
                                <div className="flex items-center justify-between py-2">
                                    ...
                                    <div className="flex items-start justify-between ltr:ml-auto rtl:mr-auto">
                                        ...
                                        <div className="dropdown ltr:ml-4 rtl:mr-4">
                                            <Dropdown offset={[0, 5]} btnClassName="hover:text-primary" button={<IconHorizontalDots className="opacity-80 hover:opacity-100" />}>
                            ...
                            <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                <div className="flex items-center justify-between py-2">
                                    ...
                                    <div className="flex items-start justify-between ltr:ml-auto rtl:mr-auto">
                                        <p className="font-semibold">90%</p>
                                        <div className="dropdown ltr:ml-4 rtl:mr-4">
                                            <Dropdown offset={[0, 5]} button={<IconHorizontalDots className="opacity-80 hover:opacity-100" />}>
                                                <ul className="!min-w-[150px]">
                                                    <li>
                                                        <button type="button">View Invoice</button>
                                                    </li>
